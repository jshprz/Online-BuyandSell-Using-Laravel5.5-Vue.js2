...
<div class="col-lg-4 col-sm-6 uk-child-width-expand@m  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match" v-for="approveditem in mainaccessories" uk-grid>
                ...
                <div class="col-lg-4 col-sm-6 uk-child-width-expand@m  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match" v-for="approveditem in mainbags" uk-grid>
                                      <div class="col-lg-12 uk-margin-small-bottom">
                                          <listcard :go="'currentitem?description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></listcard>
                                  </div>
                              </div>
                                ...
                                <div class="col-lg-4 col-sm-6 uk-child-width-expand@m  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match" v-for="approveditem in mainmenstore" uk-grid>
                                                      <div class="col-lg-12 uk-margin-small-bottom">
                                                          <listcard :go="'currentitem?description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></listcard>
                                                  </div>
                                              </div>
                                                ...
                                                <div class="col-lg-4 col-sm-6 uk-child-width-expand@m  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match" v-for="approveditem in mainwomenstore" uk-grid>
                                                                      <div class="col-lg-12 uk-margin-small-bottom">
                                                                          <listcard :go="'currentitem?description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></listcard>
                                                                  </div>
                                                              </div>
                                                                ...
                                                                <div class="col-lg-4 col-sm-6 uk-child-width-expand@m  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match" v-for="approveditem in maincomputeraccessories" uk-grid>
                                                                                      <div class="col-lg-12 uk-margin-small-bottom">
                                                                                          <listcard :go="'currentitem?description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></listcard>
                                                                                  </div>
                                                                              </div>
                                                                                ...
                                                                                <div class="col-lg-4 col-sm-6 uk-child-width-expand@m  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match" v-for="approveditem in maingadgets" uk-grid>
                                                                                                      <div class="col-lg-12 uk-margin-small-bottom">
                                                                                                          <listcard :go="'currentitem?description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></listcard>
                                                                                                  </div>
                                                                                              </div>
                                                                                                ...
                                                                                                <div class="col-lg-4 col-sm-6 uk-child-width-expand@m  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match" v-for="approveditem in mainvehicle" uk-grid>
                                                                                                                      <div class="col-lg-12 uk-margin-small-bottom">
                                                                                                                          <listcard :go="'currentitem?description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></listcard>
                                                                                                                  </div>
                                                                                                              </div>
                                                                                                                ...
                                                                                                                <div class="col-lg-4 col-sm-6 uk-child-width-expand@m  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match" v-for="approveditem in mainvehicleaccessories" uk-grid>
                                                                                                                                      <div class="col-lg-12 uk-margin-small-bottom">
                                                                                                                                          <listcard :go="'currentitem?description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></listcard>
                                                                                                                                  </div>
                                                                                                                              </div>
                                                                                                                                ...
                                                                                                                                <div class="col-lg-4 col-sm-6 uk-child-width-expand@m  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match" v-for="approveditem in mainothers" uk-grid>
                                                                                                                                                      <div class="col-lg-12 uk-margin-small-bottom">
                                                                                                                                                          <listcard :go="'currentitem?description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></listcard>
                                                                                                                                                  </div>
                                                                                                                                              </div>

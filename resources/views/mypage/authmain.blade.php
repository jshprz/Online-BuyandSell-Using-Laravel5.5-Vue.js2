...
<div class="uk-child-width-expand@s  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match"  uk-grid>
    ...
    <div class="uk-child-width-expand@s  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match"  uk-grid>
                      <div class="row" v-for="approveditem in bags">
                          <div class="col-lg-12  uk-margin-small-bottom">
                              <bags :go="'currentitem?id='+approveditem.user_id+'description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></bags>
                      </div>
                      <!--End Row-->
                    </div>
                  </div>
        ...
        <div class="uk-child-width-expand@s  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match"  uk-grid>
                          <div class="row" v-for="approveditem in menstore">
                              <div class="col-lg-12  uk-margin-small-bottom">
                                  <menstore :go="'currentitem?id='+approveditem.user_id+'description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></menstore>
                          </div>
                          <!--End Row-->
                        </div>
                      </div>
            ...
            <div class="uk-child-width-expand@s  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match"  uk-grid>
                              <div class="row" v-for="approveditem in womenstore">
                                  <div class="col-lg-12  uk-margin-small-bottom">
                                      <womenstore :go="'currentitem?id='+approveditem.user_id+'description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></womenstore>
                              </div>
                              <!--End Row-->
                            </div>
                          </div>
                ...
                <div class="uk-child-width-expand@s  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match"  uk-grid>
                                  <div class="row" v-for="approveditem in computeraccessories">
                                      <div class="col-lg-12  uk-margin-small-bottom">
                                          <computeraccessories :go="'currentitem?id='+approveditem.user_id+'description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></computeraccessories>
                                  </div>
                                  <!--End Row-->
                                </div>
                              </div>
                    ...
                    <div class="uk-child-width-expand@s  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match"  uk-grid>
                                      <div class="row" v-for="approveditem in gadgets">
                                          <div class="col-lg-12  uk-margin-small-bottom">
                                              <gadgets :go="'currentitem?id='+approveditem.user_id+'description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></gadgets>
                                      </div>
                                      <!--End Row-->
                                    </div>
                                  </div>
                        ...
                        <div class="uk-child-width-expand@s  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match"  uk-grid>
                                          <div class="row" v-for="approveditem in vehicle">
                                              <div class="col-lg-12  uk-margin-small-bottom">
                                                  <vehicle :go="'currentitem?id='+approveditem.user_id+'description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></vehicle>
                                          </div>
                                          <!--End Row-->
                                        </div>
                                      </div>
                            ...
                            <div class="uk-child-width-expand@s  uk-margin-remove-top uk-margin-remove-left uk-grid-small  uk-grid-match"  uk-grid>
                                              <div class="row" v-for="approveditem in vehicleaccessories">
                                                  <div class="col-lg-12  uk-margin-small-bottom">
                                                      <vehicleaccessories :go="'currentitem?id='+approveditem.user_id+'description='+approveditem.product_description+'&'+'price='+approveditem.product_price+'&'+'contact='+approveditem.contact+'&'+'photo='+approveditem.product_image+'&'+'created='+approveditem.created_at+'&'+'city='+approveditem.seller_location+'&'+'firstname='+approveditem.firstname+'&'+'lastname='+approveditem.lastname" :contact="approveditem.contact" :userimage="'http://localhost:8000/storage/avatars/' + approveditem.image" :productimage="'http://localhost:8000/storage/product/' + approveditem.product_image" :productdescription="approveditem.product_description" :createdat="approveditem.created_at" :productprice="approveditem.product_price" :firstname="approveditem.firstname" :lastname="approveditem.lastname" :city="approveditem.seller_location"></vehicleaccessories>
                                              </div>
                                              <!--End Row-->
                                            </div>
                                          </div>
